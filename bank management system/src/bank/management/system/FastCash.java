...
public class FastCash extends JFrame implements ActionListener {
    ...
    FastCash(String pinnumber) {
        ...
        hundred.setBounds(150, 455, 150, 30);
        hundred.addActionListener(this);
        image.add(hundred);
        
        fivehundred = new JButton("Rs 500");
        fivehundred.setBounds(370, 455, 150, 30);
        fivehundred.addActionListener(this);
        image.add(fivehundred);
        
        onethousand = new JButton("Rs 1000");
        onethousand.setBounds(150, 490, 150, 30);
        onethousand.addActionListener(this);
        image.add(onethousand);
        
        twothousand = new JButton("Rs 2000");
        twothousand.setBounds(370, 490, 150, 30);
        twothousand.addActionListener(this);
        image.add(twothousand);
        
        fivethousand = new JButton("Rs 5000");
        fivethousand.setBounds(150, 527, 150, 30);
        fivethousand.addActionListener(this);
        image.add(fivethousand);
        
        tenthousand = new JButton("Rs 10000");
        tenthousand.setBounds(370, 527, 150, 30);
        tenthousand.addActionListener(this);
        image.add(tenthousand);
        
        back = new JButton("BACK");
        back.setBounds(370, 565, 150, 30);
